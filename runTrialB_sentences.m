...
files = ["Mt190envMt10tfs.mat","Mt10envMt190tfs.mat"];
%190 funny face
%10 fast
...
sentences = ('1 - The clown has a funny face, 2 - The car is going to fast');
...
for t = 1:trials
    ...
    for k = 1:length(random_trials)
        ...
        if condition == 1
            ...
            tic
            answer = input('Which sentence did you hear? ');
            x = toc;
